...
This means we have to figure out the time of execution of the transaction that
changes the stability fee, within that transaction itself.
We do this by setting the timestamp to be the beginning of the
