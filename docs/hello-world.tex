...
\begin{itemize}
  ...
  \begin{itemize}
    \item The model will be very simple since there is not much logic in the validator
    \item DONE: model for basic logic - does the increment Plutarch work across the Integers?
    \item TODO: extend basic model to validator - does the validator behave correctly (inc tolerating bad input)?
    \item TODO: extend validator model to Tx - do only the expected Txs validate?
  \end{itemize}
